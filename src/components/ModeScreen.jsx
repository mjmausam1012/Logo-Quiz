 ...
 * - Heading: "CHOOSE MODE" in high-contrast bold italic serif with 3D drop-shadow
 * - 3 Cards side-by-side:
 *    1. SAFE MODE (backpack)
 *    2. TEAM VS TEAM (book + sparkles)
 *    3. VS ROBOT (rocket)
 * - Gradient styling on cards: golden caramel amber transitioning to rich dark chocolate maroon
 * - Navigation: sleek Back, Level indicator, and Sound toggle buttons
 */
          ...
          {modes.map((mode) => (
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center my-auto">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-black italic text-white tracking-wide uppercase transition-transform group-hover:scale-105 duration-200 leading-tight">
